...
**Nik Bear Brown** teaches at Northeastern University, where his **ENGR 0201: AI Fluency Certificate** has trained 700+ learners and anchored Northeastern's Anthropic Enterprise partnership. He is the founder of [Humanitarians AI](https://www.humanitarians.ai/) and the architect of the **Brutalist** AI-assisted production system.

He is the author of *Botspeak* (the AI-fluency curriculum) and *Computational Skepticism for AI* (the practitioner method book), both of which inform the prompt-engineering practice this volume teaches. His PhD in Computer Science is from UCLA.
...
*Fun fact: the author's resume includes circus, sumo wrestling, and photojournalism, in roughly that order.*
